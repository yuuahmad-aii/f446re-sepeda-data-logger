...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, SPI1_CS_Pin | SPI1_MPU9250_Pin | SPI1_BMP280_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPI1_CS_Pin SPI1_MPU9250_Pin SPI1_BMP280_Pin */
  GPIO_InitStruct.Pin = SPI1_CS_Pin | SPI1_MPU9250_Pin | SPI1_BMP280_Pin;
